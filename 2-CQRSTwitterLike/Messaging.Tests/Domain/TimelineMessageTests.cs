...
namespace Messaging.Tests.Domain
{
    ...
    public class TimelineMessageTests
    {
        ...
        {
            var timelineMessage = new TimelineMessage(new UserId(1), "Moi", DateTime.Now,"blabla",10);
        ...
        {
            var id = new UserId(1);
            var timelineMessage1 = new TimelineMessage(id, "Fromage", DateTime.Now,"blabla",10);
            var timelineMessage2 = new TimelineMessage(id, "Fromage", DateTime.Now,"blabla",10);
